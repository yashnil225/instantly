...
export default function CRMPage() {
    ...
    const columns = [
        ...
        { id: "lost", title: "Lost", color: "text-muted-foreground", bgColor: "bg-gray-400/10", barColor: "bg-gray-400" },
        ...availableLabels
    ...
    return (
        <div className="flex h-screen bg-background text-foreground overflow-hidden font-sans">
            {/* CRM Sub-sidebar */}
            <div className={cn(
                "border-r border-border bg-card flex flex-col transition-all duration-300 ease-in-out shrink-0",
                ...
                <div className="flex-1 overflow-y-auto py-2 px-3 no-scrollbar space-y-4">
                    {/* Inbox Section */}
                    <div className={cn("space-y-1 p-2 rounded-2xl transition-all", (view === "inbox" || view === "done" || view === "upcoming") ? "bg-secondary" : "")}>
                        <button
                            onClick={() => setView("inbox")}
                            className={cn(
                                "w-full flex items-center justify-between px-3 py-2 rounded-xl transition-all",
                                view === "inbox" ? "bg-muted" : "hover:bg-muted/50"
                            )}
                        >
                            <div className="flex items-center gap-3 text-[13px] font-black text-foreground">
                                <Inbox className="h-4 w-4 text-blue-500/70" />
                                Inbox
                            </div>
                            <span className="text-[11px] font-black text-muted-foreground bg-muted px-1.5 py-0.5 rounded">0</span>
                        </button>
                        <div className="pl-7 space-y-0.5">
                            <button
                                ...
                                className={cn(
                                    ...
                                    view === "done" ? "text-foreground bg-muted" : "text-muted-foreground hover:text-foreground"
                                )}
                            >
                                Done
                            </button>
                            <button
                                ...
                                className={cn(
                                    "w-full px-3 py-1.5 text-[12px] font-black text-left transition-all rounded-lg",
                                    view === "upcoming" ? "text-foreground bg-muted" : "text-muted-foreground hover:text-foreground"
                                )}
                            >
                                Upcoming
                            </button>
                    ...
                    <div className={cn("space-y-1 p-2 rounded-2xl transition-all", (view === "opportunities" || campaignsOpen) ? "bg-secondary" : "")}>
                        <button
                            onClick={() => {
                            ...
                            className={cn(
                                ...
                                view === "opportunities" && !selectedCampaignId ? "bg-muted text-foreground ring-1 ring-border" : "text-muted-foreground hover:text-foreground"
                            )}
                        >
                        ...
                        <div className="pl-4 space-y-4 pt-2">
                            ...
                            <div className="space-y-2">
                                <button
                                    ...
                                    className="w-full flex items-center justify-between px-3 text-[12px] font-bold text-muted-foreground hover:text-foreground transition-colors group"
                                >
                                ...
                                {campaignsOpen && (
                                    <div className="px-3 space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
                                        <div className="relative">
                                            ...
                                            <input
                                                placeholder="Search"
                                                className="w-full h-7 pl-7 bg-muted border border-border rounded-lg text-[10px] text-foreground placeholder:text-muted-foreground outline-none focus:border-primary transition-all font-bold"
                                                ...
                                                .map(c => (
                                                    <div
                                                        ...
                                                        className={cn(
                                                            ...
                                                            selectedCampaignId === c.id ? "text-blue-400" : "text-muted-foreground hover:text-blue-400"
                                                        )}
                                                    >
                                                        {c.name}
                                                    </div>
                        ...
                        <div className="space-y-1 pt-4">
                            <button
                                ...
                                className={cn(
                                    ...
                                    view === "leads" ? "bg-muted text-foreground" : "text-muted-foreground hover:text-foreground"
                                )}
                            >
                                <div className="w-1.5" />
                                All Leads
                            ...
                            {/* Salesflows */}
                            <div className={cn("space-y-2 p-2 rounded-2xl transition-all", (view === "salesflows" || salesflowsOpen) ? "bg-secondary" : "")}>
                                <button
                                    onClick={() => setSalesflowsOpen(!salesflowsOpen)}
                                    className="w-full flex items-center justify-between px-3 text-[13px] font-black text-muted-foreground hover:text-foreground transition-colors group"
                                >
                                ...
                                {salesflowsOpen && (
                                    <div className="px-3 space-y-3 animate-in fade-in slide-in-from-top-1 duration-200">
                                        <div className="relative">
                                            ...
                                            <input
                                                placeholder="Search"
                                                className="w-full h-8 pl-8 bg-muted border border-border rounded-lg text-[11px] text-foreground placeholder:text-muted-foreground outline-none focus:border-primary transition-all font-bold"
                                            ...
                                            {salesflows
                                                ...
                                                .map(s => (
                                                    <div
                                                        ...
                                                        className={cn(
                                                            "text-[11px] font-bold cursor-pointer py-1 truncate transition-colors",
                                                            view === "salesflows" ? "text-blue-400" : "text-muted-foreground hover:text-blue-400"
                                                        )}
                                                    >
                                                        {s.name}
                                                    </div>
                            ...
                            <button
                                ...
                                className={cn(
                                    "w-full flex items-center gap-3 px-3 py-2 text-[13px] font-black transition-all text-left rounded-lg",
                                    view === "reports" ? "bg-muted text-foreground" : "text-muted-foreground hover:text-foreground"
                                )}
                            >
                                <span className="w-4" />
                                Reports
            ...
            <div className="flex-1 flex flex-col min-w-0 bg-background">
                ...
                <div className="h-16 flex items-center justify-between px-8 border-b border-border z-20 bg-card/50 backdrop-blur-xl">
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-4">
                            <h1 className="text-2xl font-black text-foreground tracking-tight">CRM</h1>
                            <Button
                        ...
                        {!(view === "inbox" || view === "done" || view === "upcoming") && (
                            <div className="flex items-center gap-6 px-6 border-l border-border">
                                <div className="flex items-center gap-2">
                                    <span className="text-[13px] font-bold text-muted-foreground">{totalServerCount} opportunities</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="text-[13px] font-bold text-muted-foreground">Total:</span>
                                    <span className="text-[13px] font-black text-foreground">${(totalServerCount * opportunityValue).toLocaleString()}</span>
                                </div>
                            </div>
                        )}

                        {(view === "inbox" || view === "done" || view === "upcoming") && (
                            <div className="flex items-center gap-8 ml-4 h-full border-l border-border pl-8">
                                {["everything", "emails", "tasks"].map((tab) => (
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            inboxTab === tab ? "text-blue-400" : "text-muted-foreground hover:text-foreground"
                                        )}
                                    >
                                        {tab}
                                        {inboxTab === tab && (
                ...
                <div className="h-16 flex items-center justify-between px-8 border-b border-border z-10 bg-background">
                    <div className="relative w-80">
                        <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                        <Input
                            placeholder="Search..."
                            className="pl-11 h-10 bg-[#111116]/30 border-border focus:border-border focus:bg-[#111116] text-sm rounded-xl transition-all placeholder:text-muted-foreground font-medium text-gray-200"
                            value={searchQuery}
                        ...
                        {(view === "opportunities" || view === "leads") && (
                            <>
                                {view === "leads" ? (
                                    <DropdownMenu>
                                        <DropdownMenuTrigger asChild>
                                            <Button variant="ghost" className="h-10 px-4 rounded-xl border border-border bg-[#111116]/20 text-[12px] font-bold gap-2 text-muted-foreground hover:text-foreground transition-all shadow-sm">
                                                <List className="h-4 w-4 opacity-50" />
                                                Actions
                                                <ChevronDown className="h-3 w-3 opacity-30 ml-0.5" />
                                            </Button>
                                        </DropdownMenuTrigger>
                                        <DropdownMenuContent align="end" className="w-48 bg-[#111116] border-border rounded-xl shadow-2xl p-2 z-[60]">
                                            <DropdownMenuItem onClick={handleExportCSV} className="px-3 py-2 cursor-pointer focus:bg-[#1a1a1f] rounded-lg text-[13px] font-bold text-muted-foreground focus:text-foreground">
                                                Export CSV
                                            </DropdownMenuItem>
                                            <DropdownMenuItem
                                                onClick={() => {
                                                ...
                                                className="px-3 py-2 cursor-pointer focus:bg-[#1a1a1f] rounded-lg text-[13px] font-bold text-muted-foreground focus:text-foreground"
                                            >
                                    ...
                                    <>
                                        <DropdownMenu>
                                            <DropdownMenuTrigger asChild>
                                                <Button variant="ghost" size="sm" className="h-10 px-4 rounded-xl border border-border bg-[#111116]/20 text-[12px] font-bold gap-2 hover:bg-[#111116] text-muted-foreground hover:text-foreground transition-all">
                                                    {dateRange}
                                                    <ChevronDown className="h-3.5 w-3.5 opacity-30 ml-0.5" />
                                                </Button>
                                            </DropdownMenuTrigger>
                                            <DropdownMenuContent align="end" className="w-64 bg-[#111116] border-border rounded-xl shadow-2xl p-0 overflow-hidden z-[60]">
                                                <div className="relative p-0 border-b-2 border-blue-500/50">
                                                    <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                                                    <Input
                                                        placeholder="Search..."
                                                        className="h-12 pl-12 bg-[#1a1a1f] border-none rounded-none text-sm text-gray-200 placeholder:text-muted-foreground focus-visible:ring-0"
                                                        value={dateSearch}
                                                    ...
                                                    {[
                                                        ...
                                                        <DropdownMenuItem
                                                            ...
                                                            className={cn(
                                                                ...
                                                                dateRange === option ? "text-blue-400 bg-muted" : "text-muted-foreground focus:text-foreground"
                                                            )}
                                                        >
                                                            {option}
                                                        </DropdownMenuItem>
                                        ...
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end" className="w-[280px] bg-[#111116] border-border rounded-xl shadow-2xl p-0 overflow-hidden z-[60]">
                                                <div className="relative p-0 border-b-2 border-blue-500/50">
                                                    <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                                                    <Input
                                                        placeholder="Search..."
                                                                ...
                                                                .map((member: any) => {
                                                                    ...
                                                                    return (
                                                                        <DropdownMenuItem
                                                                            ...
                                                                            className="px-2 py-2.5 cursor-pointer focus:bg-[#1a1a1f] rounded-lg flex items-center justify-between text-[13px] font-bold text-muted-foreground transition-colors focus:text-foreground"
                                                                        >
                                                                            <div className="flex items-center gap-3">
                                        ...
                                        <DropdownMenu>
                                            <DropdownMenuTrigger asChild>
                                                <Button variant="ghost" size="icon" className="h-10 w-10 rounded-xl border border-border bg-[#111116]/20 text-muted-foreground hover:text-foreground transition-all">
                                            ...
                                            <DropdownMenuContent align="end" className="w-[280px] bg-[#111116] border-border rounded-xl shadow-2xl p-0 overflow-hidden z-[60]">
                                                <div className="relative p-4 border-b border-border">
                                                    ...
                                                    <input
                                                        placeholder="Search..."
                                                        className="w-full bg-muted border border-border rounded-lg h-9 pl-9 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:border-border transition-all"
                                                        value={labelSearch}
                                                        ...
                                                        {availableLabels.filter(l => l.toLowerCase().includes(labelSearch.toLowerCase())).map(label => {
                                                            ...
                                                            return (
                                                                <DropdownMenuItem
                                                                    ...
                                                                    className="px-3 py-2.5 cursor-pointer focus:bg-[#1a1a1f] rounded-lg flex items-center justify-between text-[13px] font-bold text-muted-foreground transition-colors focus:text-foreground"
                                                                >
                                                                    <span>{label}</span>
                                        ...
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end" className="w-56 bg-[#111116] border-border rounded-xl shadow-2xl p-2 z-[60]">
                                                <DropdownMenuItem onClick={() => router.push('/settings?tab=team')} className="px-3 py-2 cursor-pointer focus:bg-[#1a1a1f] rounded-lg text-[13px] font-bold text-muted-foreground focus:text-foreground">
                                                    <Users className="h-4 w-4 mr-2 opacity-50" />
                                                    Manage Users
                                                </DropdownMenuItem>
                                                <DropdownMenuItem onClick={() => router.push('/settings')} className="px-3 py-2 cursor-pointer focus:bg-[#1a1a1f] rounded-lg text-[13px] font-bold text-muted-foreground focus:text-foreground">
                                                    <Briefcase className="h-4 w-4 mr-2 opacity-50" />
                                                    Workspace Settings
                                                </DropdownMenuItem>
                                                <DropdownMenuItem onClick={() => router.push('/settings?tab=leads')} className="px-3 py-2 cursor-pointer focus:bg-[#1a1a1f] rounded-lg text-[13px] font-bold text-muted-foreground focus:text-foreground">
                                                    <LayoutDashboard className="h-4 w-4 mr-2 opacity-50" />
                                                    Customize View
                                                </DropdownMenuItem>
                                                <div className="h-px bg-muted my-1" />
                                                <DropdownMenuItem onClick={() => router.push('/settings?tab=preferences')} className="px-3 py-2 cursor-pointer focus:bg-[#1a1a1f] rounded-lg text-[13px] font-bold text-muted-foreground focus:text-foreground">
                    ...
                    {view === "opportunities" ? (
                        <div className="p-8 flex gap-6 no-scrollbar relative overflow-y-hidden h-full">
                            {totalServerCount === 0 && !loading && (
                                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none px-4">
                                    <div className="flex flex-col items-center gap-4 bg-[#111116]/50 p-10 rounded-[40px] border border-border backdrop-blur-sm animate-in fade-in zoom-in duration-700 max-w-lg w-full text-center">
                            ...
                            {columns.map((column) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="bg-[#111116]/40 border border-border rounded-2xl p-6 shadow-2xl transition-all group-hover/col:border-border group-hover/col:bg-[#16161c]/40 backdrop-blur-sm">
                                            <div className="flex flex-col gap-4">
                                                ...
                                                <div className="flex items-end justify-between">
                                                    ...
                                                    <div className="text-[11px] font-black text-muted-foreground uppercase tracking-widest pb-1">
                                        ...
                                        <div className="flex-1 overflow-y-auto no-scrollbar space-y-3 pb-8">
                                            {columnLeads.map((lead) => (
                                                <div
                                                    ...
                                                    className="bg-[#111116] border border-border rounded-xl p-4 shadow-xl hover:border-white/20 hover:bg-[#16161c] transition-all cursor-grab active:cursor-grabbing group relative overflow-hidden"
                                                >
                                                    <div className="flex items-center justify-between mb-2">
                                                        <div className="text-[13px] font-black text-foreground truncate max-w-[85%] font-sans">{lead.firstName} {lead.lastName}</div>
                                                        <DropdownMenu>
                                                            <DropdownMenuTrigger asChild>
                                                            ...
                                                            <DropdownMenuContent align="end" className="w-48 bg-[#111116] border-border rounded-xl shadow-2xl p-2 z-[60]">
                                                                <DropdownMenuItem onClick={(e) => { e.stopPropagation(); setEditingLead(lead); setShowEditLeadModal(true); }} className="px-3 py-2 cursor-pointer focus:bg-[#1a1a1f] rounded-lg text-[13px] font-bold text-muted-foreground focus:text-foreground">
                                                    ...
                                                    <div className="text-[11px] font-bold text-muted-foreground mb-4 flex items-center gap-2 font-sans text-left">
                                                        <span className="text-muted-foreground">{lead.company || "No Company"}</span>
                                                        <span className="opacity-20">•</span>
                                                        <span>${opportunityValue.toLocaleString()}</span>
                                                    </div>
                                                    <div className="flex items-center justify-between pt-1">
                                                        <div className="flex -space-x-1.5">
                                                            <div className="h-6 w-6 rounded-full bg-blue-600 border-2 border-[#111116] flex items-center justify-center text-[9px] font-black text-foreground shadow-lg overflow-hidden">
                                                                {lead.firstName?.[0] || "L"}
                                                            </div>
                                                        </div>
                        ...
                        <div className="p-8 h-full bg-background">
                            ...
                            <div className="bg-card border border-border rounded-2xl overflow-hidden shadow-2xl">
                                <table className="w-full text-left border-collapse">
                                    <thead>
                                        <tr className="border-b border-border text-[11px] font-black text-muted-foreground uppercase tracking-[0.15em] bg-muted">
                                    ...
                                    <tbody className="text-[13px] text-foreground font-medium">
                                        {leads.filter(l => searchQuery === "" || l.firstName?.toLowerCase().includes(searchQuery.toLowerCase()) || l.email.toLowerCase().includes(searchQuery.toLowerCase())).slice((page - 1) * rowsPerPage, page * rowsPerPage).map((l, i) => (
                                            <tr key={l.id} className={cn("border-b border-white/[0.02] transition-colors group", selectedLeads.includes(l.id) ? "bg-blue-500/5 hover:bg-blue-500/10" : "hover:bg-muted")}>
                                                <td className="px-6 py-4.5 text-muted-foreground font-black text-center whitespace-nowrap">
                                                    <div className="flex items-center gap-4">
                                                        <button
                                                            onClick={(e) => {
                                                                e.stopPropagation()
                                                            ...
                                                            className={cn(
                                                                "h-4 w-4 rounded border transition-all flex items-center justify-center",
                                                                selectedLeads.includes(l.id) ? "bg-blue-500 border-blue-500 text-foreground" : "border-white/20 hover:border-white/40"
                                                            )}
                                                        >
                                                ...
                                                <td className="px-6 py-4.5 text-foreground font-bold">{l.firstName}</td>
                                                <td className="px-6 py-4.5 text-muted-foreground">{l.lastName || "-"}</td>
                                                <td className="px-6 py-4.5 text-muted-foreground font-medium">{l.email}</td>
                                                <td className="px-6 py-4.5 text-muted-foreground">-</td>
                                                <td className="px-6 py-4.5">
                                                    {(() => {
                                                        ...
                                                        if (isGoogle) {
                                                            return (
                                                                <div className="flex items-center gap-2">
                                                                    <div className="h-4 w-4 bg-blue-600 rounded-sm flex items-center justify-center text-[10px] font-black text-foreground">G</div>
                                                                    <span className="text-muted-foreground font-bold">Google</span>
                                                                </div>
                                                            )
                                                        } else if (isMicrosoft) {
                                                            return (
                                                                <div className="flex items-center gap-2">
                                                                    <div className="h-4 w-4 bg-orange-600 rounded-sm flex items-center justify-center text-[10px] font-black text-foreground">O</div>
                                                                    <span className="text-muted-foreground font-bold">Microsoft</span>
                                                                </div>
                                                            )
                                                        } else {
                                                            return (
                                                                <div className="flex items-center gap-2">
                                                                    <div className="h-4 w-4 bg-gray-600 rounded-sm flex items-center justify-center text-[10px] font-black text-foreground">@</div>
                                                                    <span className="text-muted-foreground font-bold">{domain || 'Unknown'}</span>
                                                                </div>
                                                            )
                                                        }
                                                    })()}
                                                ...
                                                <td className="px-6 py-4.5 text-center">
                                                    <DropdownMenu>
                                                        <DropdownMenuTrigger asChild>
                                                            <Button variant="ghost" size="icon" className="h-8 w-8 text-muted-foreground hover:text-foreground transition-opacity">
                                                                <MoreHorizontal className="h-4 w-4" />
                                                            </Button>
                                                        </DropdownMenuTrigger>
                                                        <DropdownMenuContent align="end" className="w-48 bg-[#111116] border-border rounded-xl shadow-2xl p-2 z-[60]">
                                ...
                                <div className="px-8 py-5 border-t border-border flex items-center justify-between text-[11px] text-muted-foreground font-black uppercase tracking-widest bg-white/[0.01]">
                                    <div className="flex items-center gap-6">
                                        <div className="flex items-center gap-3">
                                            <span>Rows per page</span>
                                            <DropdownMenu>
                                                <DropdownMenuTrigger asChild>
                                                    <button className="flex items-center gap-2 bg-[#1a1a1f] px-3 py-1.5 rounded-lg border border-border cursor-pointer text-muted-foreground hover:text-foreground transition-colors outline-none focus:border-white/20">
                                                        <span className="text-[11px] font-black">{rowsPerPage}</span>
                                                        <ChevronDown className="h-3 w-3" />
                                                    </button>
                                                </DropdownMenuTrigger>
                                                <DropdownMenuContent side="top" align="start" className="bg-[#0c0c10] border-border text-muted-foreground z-[100] min-w-[80px]">
                                                    {[25, 50, 100, 200].map(val => (
                                                        <DropdownMenuItem
                                                            key={val}
                                                            onClick={() => { setRowsPerPage(val); setPage(1); }}
                                                            className="hover:bg-muted cursor-pointer font-bold focus:bg-muted focus:text-foreground px-3 py-2 text-[11px]"
                                                        >
                                                            {val}
                                                        </DropdownMenuItem>
                                                    ))}
                                    ...
                                    <div className="flex items-center gap-8">
                                        <div className="flex items-center gap-8">
                                            <div className="flex items-center gap-2">
                                                <span className="text-muted-foreground font-bold">Page</span>
                                                <input
                                                    type="number"
                                                    min={1}
                                                    max={totalPages}
                                                    ...
                                                    className="w-12 h-7 bg-[#111116] border border-border rounded-lg text-center text-xs font-bold text-foreground focus:border-blue-500/50 outline-none transition-all"
                                                />
                                            ...
                                            <div className="flex items-center gap-3">
                                                <Button
                                                    ...
                                                    disabled={page === 1}
                                                    className="h-9 w-9 border border-border bg-[#111116] rounded-xl hover:text-foreground transition-all disabled:opacity-30 disabled:cursor-not-allowed"
                                                >
                                    ...
                                    <div className="max-w-4xl mx-auto space-y-4">
                                            ...
                                            <div className="space-y-4">
                                                {items.map((item: any) => (
                                                    <div
                                                        ...
                                                        className="bg-[#111116] border border-border p-6 rounded-2xl flex items-center justify-between hover:border-border transition-all cursor-pointer group"
                                                    >
                                                        <div className="flex items-center gap-5">
                                                            <div className={cn(
                                                                "h-12 w-12 rounded-2xl flex items-center justify-center transition-all",
                                                                item.type === 'email' ? "bg-blue-500/10 text-blue-500 group-hover:bg-blue-500 group-hover:text-foreground" : "bg-emerald-500/10 text-emerald-500 group-hover:bg-emerald-500 group-hover:text-foreground"
                                                            )}>
                                                                {item.type === 'email' ? <Mail className="h-5 w-5" /> : <List className="h-5 w-5" />}
                                                            </div>
                                                            <div>
                                                                <div className="flex items-center gap-3">
                                                                    <h4 className="text-foreground font-black text-[15px] tracking-tight">{item.title}</h4>
                                                                    <span className={cn(
                                                                ...
                                                                <p className="text-muted-foreground text-sm mt-0.5 font-medium">{item.description}</p>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-center gap-8">
                                                            <div className="text-right">
                                                                <div className="text-[11px] font-black text-muted-foreground uppercase tracking-[0.1em]">
                                            ...
                                            <div className="space-y-2">
                                                {items.map((lead: any) => (
                                                    <div
                                                        ...
                                                        className="bg-[#111116] border border-border p-4 rounded-xl flex items-center justify-between hover:border-white/20 transition-all cursor-pointer group"
                                                    >
                                                        <div className="flex items-center gap-4">
                                                            <div className="h-10 w-10 rounded-full bg-blue-600 flex items-center justify-center font-bold text-foreground">
                                                                {lead.firstName?.[0]}
                                                            </div>
                                                            <div>
                                                                <h4 className="text-foreground font-bold">{lead.firstName} {lead.lastName}</h4>
                                        ...
                                        {view === "inbox" && inboxTab === "tasks" && (
                                            <div className="grid gap-4">
                                                {items.map((task: any) => (
                                                    <div key={task.id} className="bg-[#111116] border border-border p-5 rounded-xl flex items-center justify-between hover:border-white/20 transition-all cursor-pointer">
                                                        <div className="flex items-start gap-4">
                                                            <div className="h-10 w-10 rounded-lg bg-emerald-500/10 flex items-center justify-center text-emerald-500">
                                                                <List className="h-5 w-5" />
                                                            </div>
                                                            <div>
                                                                <h4 className="text-foreground font-bold">{task.title}</h4>
                                            ...
                                            <div className="grid gap-4">
                                                {items.map((item: any) => (
                                                    <div key={item.id} className="bg-[#111116] border border-blue-500/20 p-6 rounded-2xl relative overflow-hidden group hover:border-blue-500/40 transition-all">
                                                        ...
                                                        <div className="space-y-4">
                                                            <div className="flex items-center gap-3">
                                                                <div className="h-8 w-8 rounded-full bg-muted flex items-center justify-center text-muted-foreground font-bold text-xs">AI</div>
                                                            ...
                                                            <div className="flex items-center gap-2 pt-2">
                                                                <Button
                                                                    ...
                                                                    size="sm"
                                                                    className="h-8 bg-blue-600 hover:bg-blue-500 text-foreground font-bold rounded-lg text-xs"
                                                                >
                                                                    Approve
                                                                </Button>
                                                                <Button
                                                                    ...
                                                                    size="sm"
                                                                    variant="ghost"
                                                                    className="h-8 text-muted-foreground hover:text-foreground font-bold rounded-lg text-xs"
                                                                >
                                                                    Dismiss
                                                                </Button>
                                                            </div>
                                        ...
                                        {view === "done" && (
                                            <div className="space-y-3">
                                                {items.map((item: any) => (
                                                    <div key={item.id} className="bg-[#111116] border border-border p-5 rounded-2xl flex items-center justify-between group hover:border-border transition-all opacity-80">
                                                        <div className="flex items-center gap-4">
                                                            <div className="h-10 w-10 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-500">
                                                                <Check className="h-5 w-5" />
                                                            </div>
                                                            <div>
                                                                <h4 className="text-foreground font-black text-sm tracking-tight line-through opacity-50">{item.title}</h4>
                                                                <p className="text-muted-foreground text-xs font-bold uppercase tracking-widest">{item.description}</p>
                                                            </div>
                                                        </div>
                                                        <div className="text-right">
                                                            ...
                                                            <Button
                                                                size="icon" variant="ghost" className="h-6 w-6 text-muted-foreground hover:text-foreground mt-1"
                        ...
                        <div className="p-8 space-y-8 animate-in fade-in duration-700 h-full overflow-y-auto no-scrollbar pb-20">
                            <div className="flex items-end justify-between mb-2">
                                <div>
                                    <h2 className="text-3xl font-black text-foreground tracking-tight">Campaign Reports</h2>
                                    <p className="text-muted-foreground font-bold mt-1">Performance overview across all your active campaigns.</p>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                {[
                                    ...
                                    <div key={i} className="bg-card border border-border p-6 rounded-3xl shadow-2xl hover:border-border transition-all group relative overflow-hidden">
                                        <div className="flex items-start justify-between relative z-10">
                                            <div className="space-y-4">
                                                ...
                                                <div>
                                                    <div className="text-[11px] font-black text-muted-foreground uppercase tracking-[0.2em] mb-1">{stat.label}</div>
                                                    <div className="text-3xl font-black text-foreground tracking-tighter">{stat.value}</div>
                                                </div>
                                            </div>
                                            <div className="absolute -top-4 -right-4 h-24 w-24 bg-muted rounded-full blur-2xl group-hover:bg-white/[0.05] transition-all" />
                                        </div>
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="bg-card border border-border rounded-3xl overflow-hidden shadow-2xl">
                                <div className="px-8 py-6 border-b border-border flex items-center justify-between bg-muted">
                                    <h3 className="text-[13px] font-black text-foreground uppercase tracking-widest">Campaign Performance</h3>
                                    <Button variant="ghost" size="sm" className="text-[11px] font-black text-muted-foreground hover:text-foreground uppercase tracking-widest">View All</Button>
                                </div>
                                <div className="overflow-x-auto">
                                    <table className="w-full text-left border-collapse">
                                        ...
                                        <tbody className="text-[13px] text-muted-foreground font-bold">
                                            {campaigns.slice(0, 5).map((c, i) => (
                                                ...
                                                >
                                                    <td className="px-8 py-4 text-foreground font-black">{c.name}</td>
                                                    <td className="px-8 py-4 text-foreground">{(c.sentCount || 0).toLocaleString()}</td>
                                                    ...
                                                    <td className="px-8 py-4">
                                                        <span className={cn(
                                                            ...
                                                            c.status === 'active' ? "bg-emerald-500/10 text-emerald-500" : "bg-gray-500/10 text-muted-foreground"
                                                        )}>
                                                            {c.status}
                                                        </span>
                                                    </td>
                        ...
                        <div className="flex-1 relative overflow-hidden h-full flex flex-col items-center justify-center p-20 text-center space-y-8 bg-background">
                            <div className="space-y-6 max-w-xl">
                                <h3 className="text-[56px] font-black text-foreground tracking-tighter leading-tight">Feature Coming Soon</h3>
                                <p className="text-muted-foreground font-bold text-2xl leading-relaxed">
                                    We are working hard to bring this feature to your CRM. Stay tuned!
                                </p>
                            </div>
                            <Button
                                onClick={() => setView("opportunities")}
                                className="bg-blue-600 hover:bg-blue-500 text-foreground font-black px-12 h-14 text-lg rounded-2xl transition-all shadow-[0_0_30px_rgba(37,99,235,0.3)] border-none"
                            >
                                Go Back
                            </Button>
                        </div>
                    ...
                    <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-500">
                        <div className="w-full max-w-[720px] bg-[#1a1b1e] border border-white/[0.03] rounded-2xl shadow-2xl overflow-hidden min-h-[480px] flex flex-col relative">
                            <div className="p-16 flex-1 space-y-12">
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        <h2 className="text-2xl font-bold text-foreground tracking-tight">Welcome to Dealflow</h2>
                                    ...
                                    <div className="space-y-6 max-w-lg">
                                        ...
                                        <p className="text-[14px] text-muted-foreground font-medium italic">You can always change this later in settings.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-6 pt-4">
                                    ...
                                    <input
                                        type="text"
                                        autoFocus
                                        className="bg-transparent border-b-2 border-border focus:border-blue-500 text-5xl font-bold text-foreground w-64 outline-none transition-all pb-4 placeholder:text-white/5"
                                        value={welcomeValue}
                                ...
                                <div className="absolute bottom-16 right-16 flex flex-col items-end gap-6">
                                    <Button
                                        ...
                                        className="bg-[#244da0] hover:bg-blue-600 text-foreground font-bold h-14 px-10 rounded-xl text-base shadow-xl transition-all active:scale-[0.98] border border-blue-400/20"
                                    >
                                        Set default value
                                    </Button>
                                    <button
                                        ...
                                        className="text-[11px] font-black text-muted-foreground hover:text-muted-foreground uppercase tracking-widest transition-colors pr-2"
                                    >
                                        Maybe later
                                    </button>
                                </div>
            ...
            {/* Unified Create/Rename Modal */}
            {
                showUnifiedModal && (
                    <div className="fixed inset-0 z-[300] flex items-center justify-center p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
                        <div className="w-full max-w-sm bg-[#0c0c10] border border-border rounded-3xl shadow-2xl p-8 space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className="bg-muted border-border h-11 rounded-xl text-foreground font-bold"
                                        autoFocus
                                    />
                                </div>
                                <div className="flex gap-3">
                                    <Button
                                        ...
                                        className="flex-1 h-11 rounded-xl font-bold text-muted-foreground hover:text-foreground"
                                    >
                                        Cancel
                                    </Button>
                                    <Button
                                        ...
                                        className="flex-1 h-11 bg-blue-600 hover:bg-blue-500 text-foreground font-black rounded-xl"
                                    >
            ...
            {/* Success Toast */}
            {
                showSuccessToast && (
                    <div className="fixed bottom-8 right-8 z-[500] animate-in fade-in slide-in-from-right-8 duration-500">
                        <div className="bg-emerald-500 text-foreground px-6 py-4 rounded-2xl shadow-[0_0_40px_rgba(16,185,129,0.3)] flex items-center gap-3">
            ...
            {/* Bulk Edit Modal */}
            {
                showBulkEditModal && (
                    <div className="fixed inset-0 z-[400] flex items-center justify-center p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
                        <div className="w-full max-w-sm bg-[#0c0c10] border border-border rounded-3xl shadow-2xl p-8 space-y-6">
                            <div className="space-y-1">
                                <h3 className="text-xl font-bold text-foreground">Bulk Edit ({selectedLeads.length})</h3>
                                <p className="text-xs text-muted-foreground font-medium italic">Update status or labels for selected leads.</p>
                            </div>
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest pl-1">New Status</label>
                                        ...
                                        {["replied", "won", "interested", "lost"].map(s => (
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    bulkEditStatus === s ? "bg-blue-600 border-blue-500 text-foreground" : "bg-muted border-border text-muted-foreground hover:bg-white/10"
                                                )}
                                            >
                                                {s}
                                            </button>
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest pl-1">New Label</label>
                                        ...
                                        {availableLabels.map(l => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={cn(
                                                        "px-3 py-2 rounded-xl text-[11px] font-black uppercase tracking-wider border transition-all",
                                                        bulkEditLabel === id ? "bg-purple-600 border-purple-500 text-foreground" : "bg-muted border-border text-muted-foreground hover:bg-white/10"
                                                    )}
                                                >
                                                    {l}
                                                </button>
            ...
            {/* Custom Date Range Modal */}
            {
                showCustomDateModal && (
                    <div className="fixed inset-0 z-[400] flex items-center justify-center p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
                        <div className="w-full max-w-sm bg-[#0c0c10] border border-border rounded-3xl shadow-2xl p-8 space-y-6">
                            <div className="space-y-1">
                                <h3 className="text-xl font-bold text-foreground">Custom Date Range</h3>
                                <p className="text-xs text-muted-foreground font-medium italic">Select start and end dates for filtering.</p>
                            </div>
                            <div className="space-y-4">
                                <div className="grid gap-4">
                                    <div className="space-y-2">
                                ...
                                <div className="flex gap-3 pt-2">
                                    ...
                                    <Button
                                        ...
                                        className="flex-1 h-11 bg-blue-600 hover:bg-blue-500 text-foreground font-black rounded-xl shadow-[0_0_20px_rgba(37,99,235,0.2)]"
                                    >
                                        Apply
                                    </Button>
                                </div>
            ...
            {/* Campaign Detail Modal */}
            {
                selectedReportCampaignId && (
                    <div className="fixed inset-0 z-[400] flex items-center justify-center p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
                        <div className="w-full max-w-4xl bg-[#0c0c10] border border-border rounded-[40px] shadow-2xl p-10 space-y-8 max-h-[90vh] overflow-y-auto no-scrollbar relative">
                            <button
                                    ...
                                    <div className="space-y-8">
                                            ...
                                            <div className="space-y-2">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <span className={cn(
                                                        ...
                                                        campaign.status === 'active' ? "bg-emerald-500/10 text-emerald-500" : "bg-gray-500/10 text-muted-foreground"
                                                    )}>
                                                        {campaign.status}
                                                    </span>
                                                </div>
                                                <h2 className="text-4xl font-black text-foreground tracking-tighter">{campaign.name}</h2>
                                            </div>
                                            <div className="flex flex-col items-end gap-1">
                                                <div className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Created On</div>
                                                <div className="text-foreground font-bold">{new Date(campaign.createdAt || Date.now()).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            {[
                                                ...
                                                <div key={i} className="bg-muted border border-border p-6 rounded-3xl space-y-3">
                                                    <div className="flex items-center justify-between">
                                                        <stat.icon className={cn("h-5 w-5", stat.color)} />
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                            <div className="space-y-6">
                                                <h3 className="text-lg font-black text-foreground uppercase tracking-widest">Sequence Flow</h3>
                                                <div className="space-y-4">
                                                    {[
                                                        ...
                                                        <div key={i} className="bg-white/[0.01] border border-border p-4 rounded-2xl flex items-center justify-between group hover:bg-muted transition-all">
                                                            <div className="flex items-center gap-4">
                                                                <div className="h-10 w-10 rounded-xl bg-blue-500/10 flex items-center justify-center text-blue-500 font-black text-xs">
                                                                    {s.step}
                                                                </div>
                                                                <div>
                                                                    <div className="text-foreground font-bold text-sm">{s.type}</div>
                                                                    <div className="text-muted-foreground text-[10px] font-black uppercase">{s.wait}</div>
                                                                </div>
                                                            </div>
                                                            <div className="text-[11px] text-muted-foreground font-bold truncate max-w-[150px]">{s.subject}</div>
                                                        </div>
                                                    ))}
                                                </div>
                                            </div>
                                            ...
                                            <div className="space-y-6">
                                                <h3 className="text-lg font-black text-foreground uppercase tracking-widest">Performance Over Time</h3>
                                                <div className="h-48 w-full bg-white/[0.01] border border-dashed border-border rounded-3xl flex items-center justify-center relative overflow-hidden">
                                                    ...
                                                    <span className="text-muted-foreground text-[10px] font-black uppercase tracking-widest relative z-10">Last 10 Days Activity</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex justify-end pt-4">
                                            <Button
                                                onClick={() => setSelectedReportCampaignId(null)}
                                                className="bg-muted hover:bg-white/10 text-foreground font-black px-8 h-12 rounded-xl border border-border"
                                            >
                                                Close View
                                            </Button>
                                        </div>
                    ...
                    <div className="fixed inset-0 z-[400] flex items-center justify-center p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
                        <div className="w-full max-w-sm bg-[#0c0c10] border border-border rounded-3xl shadow-2xl p-8 space-y-6">
                            <div className="space-y-1">
                                ...
                                <p className="text-xs text-muted-foreground font-medium italic">Update task message or schedule.</p>
                            </div>
                            <div className="space-y-4">
                                <div className="space-y-2">
            ...
            {/* Lead Detail Modal */}
            {
                showLeadDetailModal && selectedLeadForDetail && (
                    <div className="fixed inset-0 z-[400] flex items-center justify-center p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
                        <div className="w-full max-w-5xl bg-[#0c0c10] border border-border rounded-[40px] shadow-2xl p-10 space-y-8 max-h-[90vh] overflow-y-auto no-scrollbar relative flex gap-8">
                            <button
                            ...
                            {/* Left: Lead Info */}
                            <div className="w-80 shrink-0 space-y-8 border-r border-border pr-8">
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-black text-foreground tracking-tight">{selectedLeadForDetail.firstName} {selectedLeadForDetail.lastName}</h2>
                                        <p className="text-sm text-muted-foreground font-bold">{selectedLeadForDetail.title} @ {selectedLeadForDetail.companyName}</p>
                                    </div>
                                </div>

                                <div className="space-y-6">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Contact Info</label>
                                        <div className="space-y-3">
                            ...
                            <div className="flex-1 space-y-8">
                                <div className="flex items-center gap-8 border-b border-border pb-4">
                                    <button className="text-sm font-black text-foreground border-b-2 border-blue-500 pb-4 -mb-[18px]">Activity</button>
                                    <button className="text-sm font-black text-muted-foreground hover:text-muted-foreground pb-4">Email History</button>
                                    <button className="text-sm font-black text-muted-foreground hover:text-muted-foreground pb-4">Tasks</button>
                                </div>
                                        ...
                                        logs.filter(l => l.leadId === selectedLeadForDetail.id).map((log, i) => (
                                            <div key={i} className="flex gap-4 group">
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">{new Date(log.createdAt).toLocaleString()}</span>
                                                </div>
                                            </div>
                                        ))
                                    ) : (
                                        <div className="py-12 flex flex-col items-center justify-center text-center space-y-4">
                                            <div className="h-16 w-16 rounded-[24px] bg-muted border border-border flex items-center justify-center text-muted-foreground">
                                                <Clock className="h-8 w-8 opacity-20" />
                                            </div>
                                            <p className="text-muted-foreground text-xs font-black uppercase tracking-widest">No recent activity</p>
                                        </div>
                                    )}
                                </div>
                            </div>
            ...
            {/* Edit Lead Modal */}
            {
                showEditLeadModal && editingLead && (
                    <div className="fixed inset-0 z-[400] flex items-center justify-center p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
                        <div className="w-full max-w-lg bg-[#0c0c10] border border-border rounded-[40px] shadow-2xl p-10 space-y-8 relative">
                            <div className="space-y-2">
                                <h3 className="text-2xl font-black text-foreground tracking-tight">Edit Lead</h3>
                                <p className="text-sm text-muted-foreground font-bold uppercase tracking-widest">Update lead details and attributes</p>
                            </div>

                            <div className="grid grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest pl-1">First Name</label>
                                    <Input
                                        value={editingLead.firstName || ''}
                                        onChange={(e) => setEditingLead({ ...editingLead, firstName: e.target.value })}
                                        className="bg-muted border-border h-12 rounded-2xl text-foreground font-bold px-5 focus:ring-2 focus:ring-blue-500/20 transition-all"
                                    />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest pl-1">Last Name</label>
                                    <Input
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest pl-1">Company</label>
                                    <Input
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest pl-1">Title</label>
                                    <Input
                            ...
                            <div className="flex gap-4 pt-4">
                                <Button
                                    ...
                                    className="flex-1 h-12 rounded-2xl font-bold text-muted-foreground hover:text-foreground transition-all hover:bg-muted"
                                >
                                    Cancel
                                </Button>
                                <Button
                                    ...
                                    className="flex-1 h-12 bg-blue-600 hover:bg-blue-500 text-foreground font-black rounded-2xl shadow-[0_0_20px_rgba(37,99,235,0.2)] transition-all transform hover:scale-[1.02]"
                                >
            ...
            {/* Email Preview Modal */}
            {
                showEmailPreviewModal && selectedEmail && (
                    <div className="fixed inset-0 z-[400] flex items-center justify-center p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
                        <div className="w-full max-w-2xl bg-[#0c0c10] border border-border rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[80vh]">
                            <div className="p-6 border-b border-border flex items-center justify-between bg-[#111116]">
                                <h3 className="text-lg font-bold text-foreground truncate max-w-md">{selectedEmail.title}</h3>
                                <Button variant="ghost" size="icon" onClick={() => setShowEmailPreviewModal(false)}><Zap className="h-5 w-5 rotate-45 text-muted-foreground hover:text-foreground" /></Button>
                            </div>
                            <div className="p-8 overflow-y-auto bg-muted flex-1">
                                <div className="space-y-8">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div className="text-foreground font-bold text-lg">{selectedEmail.title}</div>
                                                <div className="text-muted-foreground text-sm font-medium">{selectedEmail.description}</div>
                                            </div>
                                        </div>
                                        <div className="text-muted-foreground text-[10px] font-black uppercase tracking-widest bg-muted px-2 py-1 rounded-lg">{new Date(selectedEmail.timestamp).toLocaleString()}</div>
                                    </div>
                                    <div className="prose prose-invert max-w-none text-sm text-foreground leading-relaxed">
                                        {selectedEmail.lead ? (
                                            <div className="space-y-4">
                                                <div className="grid grid-cols-2 gap-4">
                                                    <div><span className="text-muted-foreground">Email:</span> <span className="text-foreground">{selectedEmail.lead.email}</span></div>
                                                    <div><span className="text-muted-foreground">Company:</span> <span className="text-foreground">{selectedEmail.lead.company || '-'}</span></div>
                                                    <div><span className="text-muted-foreground">Status:</span> <span className="text-foreground">{selectedEmail.lead.status || '-'}</span></div>
                                                    <div><span className="text-muted-foreground">Label:</span> <span className="text-foreground">{selectedEmail.lead.aiLabel || '-'}</span></div>
                                                </div>
                                                {selectedEmail.lead.personalNote && (
                                                    <div className="border-t border-border pt-4">
                                                        <p className="text-muted-foreground mb-1">Notes:</p>
                                                        <p className="text-foreground">{selectedEmail.lead.personalNote}</p>
                                                    </div>
                                                )}
                                                <p className="text-muted-foreground italic text-[11px] mt-4">View full conversation in Unibox →</p>
                                            </div>
                                        ) : (
                            ...
                            <div className="p-4 border-t border-border bg-[#111116] flex justify-end gap-3">
                                <Button variant="ghost" onClick={() => setShowEmailPreviewModal(false)} className="font-bold text-muted-foreground hover:text-foreground">Close</Button>
                                <Button className="bg-blue-600 text-foreground font-bold rounded-xl px-6" onClick={() => { router.push(`/app/unibox?leadId=${selectedEmail.id}`); setShowEmailPreviewModal(false); }}>Reply in Unibox</Button>
                            </div>
                        </div>
                    </div>
                )
            ...
            {/* Custom Date Range Modal */}
            {
                showCustomDateModal && (
                    <div className="fixed inset-0 z-[400] flex items-center justify-center p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
                        <div className="w-full max-w-md bg-[#0c0c10] border border-border rounded-3xl shadow-2xl p-8 space-y-6">
                            <div className="space-y-1">
                                <h3 className="text-xl font-bold text-foreground">Custom Date Range</h3>
                                <p className="text-xs text-muted-foreground font-medium">Select a start and end date for filtering.</p>
                            </div>
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest pl-1">Start Date</label>
                                ...
                                <div className="flex gap-3 pt-2">
                                    ...
                                    <Button
                                        ...
                                        className="flex-1 h-11 bg-blue-600 hover:bg-blue-500 text-foreground font-black rounded-xl disabled:opacity-50"
                                    >
                                        Apply Range
                                    </Button>
                                </div>
            ...
            {/* Bulk Edit Modal */}
            {
                showBulkEditModal && selectedLeads.length > 0 && (
                    <div className="fixed inset-0 z-[400] flex items-center justify-center p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
                        <div className="w-full max-w-md bg-[#0c0c10] border border-border rounded-3xl shadow-2xl p-8 space-y-6">
                            <div className="space-y-1">
                                <h3 className="text-xl font-bold text-foreground">Bulk Edit {selectedLeads.length} Leads</h3>
                                <p className="text-xs text-muted-foreground font-medium">Update status or label for all selected leads.</p>
                            </div>
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest pl-1">New Status</label>
                                    <select
                                        ...
                                        className="w-full bg-muted border border-border h-11 rounded-xl text-foreground font-bold px-3"
                                    >
