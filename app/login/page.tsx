            ...
            <div className="flex flex-col items-center w-full">
                ...
                <div style={{ marginTop: '48px', width: '358px' }} className="flex flex-col items-center">
                    ...
                    >
                        ...
                        <span className="text-[15px] font-semibold text-slate-700 tracking-normal">Log In with Google</span>
                    </button>
                    ...
                    >
                        ...
                        <span className="text-[15px] font-semibold text-slate-700 tracking-normal">Log In with Apple</span>
                    </button>
