            ...
            <div className="flex flex-col items-center w-full">
                ...
                <div style={{ marginTop: '49px', width: '358px' }} className="flex flex-col items-center">
                    ...
                    <button
                        ...
                        style={{ width: '360px', height: '54px', borderRadius: '8px', padding: '0 24px', boxShadow: '0 3px 5px 0 rgb(222 222 222 / 30%)' }}
                    >
                        <svg width="18" height="18" viewBox="0 0 24 24" className="mt-[-2px]">
                    ...
                    <button
                        ...
                        style={{ width: '360px', height: '54px', borderRadius: '8px', padding: '0 24px', boxShadow: '0 3px 5px 0 rgb(222 222 222 / 30%)' }}
                    >
                        <svg viewBox="0 0 384 512" width="18" height="18" className="mt-[-2px]">
                    ...
                    >
                        <input
                            ...
                            required
                            style={{ width: '360px', height: '56px', borderRadius: '2px', padding: '27px 24px', color: 'rgb(194,198,201)', fontWeight: '400' }}
                    ...
                    {/* Login Button → Forgot Password: 16px */}
                    <div style={{ height: '16px' }} />
