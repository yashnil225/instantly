...
export default function LoginPage() {
    ...
    const handleGoogleSignIn = async () => {
        ...
        setError("")
        try {
            // Use NextAuth's default redirect handling - fixes OAuth issues
            await signIn("google", { 
                callbackUrl: "/campaigns?welcome=true"
            })
            ...
            <div className="w-full max-w-md">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                        <button
                            type="button"
                            className="w-full px-4 py-3 bg-card border border-border rounded-lg text-foreground hover:bg-secondary transition-colors flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
