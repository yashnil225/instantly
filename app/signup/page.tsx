...
function SignupForm() {
    ...
    // Dynamic Validation & Password Visibility (Permanent once revealed)
    useEffect(() => {
        if (email.length > 0) {
            ...
            // Do not hide password once revealed, only reset validation
            setEmailValid(true)
        }
    }, [email])
    ...
    return (
        <div className="auth-no-scroll relative flex bg-white h-screen overflow-hidden">
            ...
            <div className="flex-shrink-0 bg-white relative h-full" style={{ width: '58vw' }}>
                <div className="flex flex-col items-start h-full overflow-y-auto" style={{ paddingLeft: '218px' }}>
                    <div 
                        ...
                        style={{ transform: showPassword ? 'translateY(-50px)' : 'translateY(0)' }}
                    >
                    ...
                    >
                        ...
                        <span className="text-[16px] font-semibold text-slate-700">Sign Up with Google</span>
                    </button>
                    ...
                    <form onSubmit={handleSubmit} style={{ width: '358px' }}>
                        <div className="relative" style={{ width: '358px' }}>
                            <input
                                ...
                                required
                                style={{ width: '360px', height: '56px', borderRadius: '2px', color: 'rgb(113,121,129)' }}
                        ...
                        {/* Tick Area → Join Now Button: 30px */}
            ...
            {/* Right Side: Marketing (Fixed 376px content width per original asset) */}
            <div className="hidden lg:flex flex-1 relative flex-col items-center justify-center h-full z-0 overflow-hidden" style={{ background: '#f8f9fb' }}>
                {/* Wavy Logo Background Overlay - Matches natural SVG dimensions (692x920) */}
                <div 
                    className="absolute top-0 right-0 bg-instantly-waves opacity-100 pointer-events-none -z-10" 
                    style={{ 
                        width: '692px', 
                        height: '920px', 
                ...
                <div className="relative z-10 text-center flex flex-col items-center" style={{ width: '376px' }}>
                    {/* Illustration - Fixed 200px Height per original asset */}
                    <div className="mb-12 animate-in slide-in-from-bottom-4 duration-1000" style={{ height: '200px', width: 'auto' }}>
                        <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 206 200" className="w-full h-full">
                            ...
                            <g clipPath="url(#g)"><path d="M140.1 191.8v.4a2 2 0 0 1-1.9 2H65.4a2 2 0 0 1-2-2v-.4a2 2 0 0 1 2-1.9h72.8a2 2 0 0 1 2 2Z" fill="#DBDFEA" /><path d="M65.4 194.3h72.8a2.1 2.1 0 0 0 2.1-2.1v-.4a2.1 2.1 0 0 0-2.1-2.1H65.4a2.1 2.1 0 0 0-2.2 2.1v.4a2.1 2.1 0 0 0 2.2 2Zm72.8-4.2a1.8 1.8 0 0 1 1.8 1.7v.4a1.8 1.8 0 0 1-1.8 1.7H65.4a1.8 1.8 0 0 1-1.8-1.7v-.4a1.8 1.8 0 0 1 1.8-1.7h72.8Z" fill="#14171F" /><path d="M20.7 140.3h72.8c1 0 2 1 2.3 2l10.6 49.8c.2 1-.5 2-1.6 2H32c-1 0-2.1-1-2.3-2L19 142.3c-.2-1 .5-2 1.6-2Z" fill="#DBDFEA" /><path d="M32 194.2h72.8a1.7 1.7 0 0 0 1.4-.6 1.8 1.8 0 0 0 .3-1.6L96 142.3a2.7 2.7 0 0 0-2.5-2.1H20.7a1.7 1.7 0 0 0-1.4.6 1.8 1.8 0 0 0-.4 1.5l10.6 49.8a2.7 2.7 0 0 0 2.5 2.1Zm61.5-53.7c1 0 2 .8 2.1 1.8l10.6 49.8a1.5 1.5 0 0 1-.3 1.3 1.4 1.4 0 0 1-1 .5H32c-1 0-2-.9-2-2l-10.6-49.7c0-1 1-1.9 2-1.9h72.9Z" fill="#14171F" /><path d="M71.8 167.6 71 165a1.7 1.7 0 0 0-1.6-1.3h-15a1 1 0 0 0-1 1.2l.8 2.6a1.7 1.7 0 0 0 1.7 1.4h15a1 1 0 0 0 1-1.3Z" fill="#fff" /><path d="M55.9 169h15a1.2 1.2 0 0 0 1.1-1.4l-.8-2.6a1.9 1.9 0 0 0-1.8-1.5h-15a1.2 1.2 0 0 0-1 .4 1.2 1.2 0 0 0-.2 1l.8 2.7A1.9 1.9 0 0 0 56 169Zm15.7-1.3a.8.8 0 0 1-.4 1H55.8a1.5 1.5 0 0 1-1.4-1.2l-.8-2.6a.8.8 0 0 1 .8-1h15a1.5 1.5 0 0 1 1.4 1.2l.8 2.6Z" fill="#14171F" /></g>
