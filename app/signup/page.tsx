                ...
                <div className="h-full flex flex-col items-center md:items-start md:pl-[218px] py-12 lg:py-0">
                    ...
                    <div className="flex flex-col items-start px-4 md:px-0">
                        ...
                        >
                            ...
                            <span className="text-[15px] font-semibold text-slate-700 tracking-wider">Sign Up with Google</span>
                        </button>
                        ...
                        >
                            ...
                            <span className="text-[15px] font-semibold text-slate-700 tracking-wider">Sign Up with Apple</span>
                        </button>
                        ...
                        <div className="flex items-center gap-4" style={{ width: '358px' }}>
                            ...
                            <span className="text-[13px] text-[rgb(135,149,168)] tracking-normal uppercase font-medium" style={{ fontWeight: '500 !important' } as any}>OR</span>
                            <div className="flex-1 h-[1px] bg-[rgb(222,226,230)] mt-[-3px]"></div>
                        </div>
