...
function SignupForm() {
    ...
    return (
        <div className="relative flex flex-col md:flex-row bg-white dark:bg-[#191a1b] h-screen overflow-hidden">
            ...
            <div className="flex-shrink-0 bg-white dark:bg-[#191a1b] relative w-full md:w-[58vw] min-h-screen lg:h-screen" style={{}}>
                <div className="h-full flex flex-col items-center md:items-start md:pl-[218px] py-12 lg:py-0">
                    ...
                    <div className="flex flex-col items-start px-4 md:px-0">
                        ...
                        <h1 className="text-[32px] font-semibold text-slate-900 dark:text-white tracking-normal text-center" style={{ width: '360px' }}>
                        ...
                        >
                            <svg width="20" height="20" viewBox="0 0 48 48" className="relative left-[2px]">
                            ...
                            <span className="text-[15.5px] font-semibold text-slate-700 dark:text-white tracking-[0.045em] relative top-[1px]">Sign Up with Google</span>
                        </button>
                        ...
                        <button
                            ...
                            style={{ width: '360px', height: '54px', borderRadius: '12px', padding: '0 24px', boxShadow: '0 2px 6px rgba(0, 0, 0, 0.06)' }}
                        >
                            <svg viewBox="0 0 384 512" width="22" height="22" className="mt-[-4px] relative left-[2px]">
                                <path fill="currentColor" d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z" />
                            </svg>
                            <span className="text-[15.5px] font-semibold text-slate-700 dark:text-white tracking-[0.045em] relative top-[1px]">Sign Up with Apple</span>
                        </button>

                        {/* Social Buttons → OR Divider: Reduced significantly when expanded */}
                        <div style={{ height: showPassword ? '14px' : '18px', transition: 'height 0.4s ease-in-out' }} />

                        {/* OR Divider */}
                        <div className="flex items-center gap-4" style={{ width: '358px' }}>
                            <div className="flex-1 h-[1px] bg-[rgb(222,226,230)] dark:bg-[rgba(255,255,255,0.1)] mt-[-3px]"></div>
                            <span className="text-[12.35px] text-[rgb(135,149,168)] dark:text-gray-400 tracking-normal uppercase font-medium" style={{ fontWeight: '500 !important' } as any}>OR</span>
                            <div className="flex-1 h-[1px] bg-[rgb(222,226,230)] dark:bg-[rgba(255,255,255,0.1)] mt-[-3px]"></div>
                        </div>

                        {/* OR Divider → Email Field: Reduced significantly when expanded */}
                        <div style={{ height: showPassword ? '8px' : '10px', transition: 'height 0.4s ease-in-out' }} />
                        ...
                        <form onSubmit={handleSubmit} style={{ width: '358px' }}>
                            <div className="relative" style={{ width: '358px' }}>
                                <input
                                    ...
                                    required
                                    style={{ width: '360px', height: '56px', borderRadius: '8px', fontWeight: '400' }}
                                    className="auth-input text-[rgb(113,121,129)] dark:text-white"
                                />
                                {!emailValid && (
                            ...
                            {/* Tick Area → Join Now Button */}
                            <div style={{ height: showPassword ? '24px' : '24px', transition: 'height 0.4s ease-in-out' }} />
                            ...
                            {/* Footer */}
                            <div className="text-center text-[16px] relative top-[2px] left-[1px] text-[rgb(96,106,119)] dark:text-gray-300" style={{ width: '358px' }}>
            ...
            <div className="hidden md:flex w-[42vw] relative flex-col items-center justify-center p-12 h-full z-0">
                ...
                <div className="relative z-10 max-w-md text-center flex flex-col items-center left-[-4px] transition-all duration-500 ease-in-out" style={{ marginTop: showPassword ? '-180px' : '-130px' }}>
                    ...
                    {/* Marketing Text */}
                    <h2 className="text-[23px] font-semibold text-black dark:text-white mb-1 leading-tight tracking-tight">
                        45,000+ clients
                    </h2>
                    <p className="text-black dark:text-white text-[23px] font-semibold mb-[26px]">
                        are getting more replies!
                    </p>
                    <p className="text-[15.5px] leading-[2.0] max-w-sm font-medium px-2 text-[#7687a5] dark:text-gray-400">
