    ...
    return (
        <div className="relative flex flex-col md:flex-row bg-white h-screen overflow-hidden">
            ...
            <div className="flex-shrink-0 bg-white relative w-full md:w-[58vw] min-h-screen lg:h-screen" style={{}}>
                <div className="h-full flex flex-col items-center md:items-start md:pl-[218px] py-12 lg:py-0">
                    ...
                    <div className="flex flex-col items-start px-4 md:px-0">
                        ...
                        <div style={{ height: showPassword ? '38px' : '98px', transition: 'height 0.4s ease-in-out' }} />
                        ...
                        <form onSubmit={handleSubmit} style={{ width: '358px' }}>
                            ...
                            <div style={{ height: showPassword ? '38px' : '36px', transition: 'height 0.4s ease-in-out' }} />
            ...
            <div className="hidden md:flex w-[42vw] relative flex-col items-center justify-center p-12 h-full z-0">
                ...
                <div className={`absolute top-[-6px] bottom-0 right-[-10px] transition-all duration-500 ease-in-out ${showPassword ? 'w-[125%]' : 'w-[121%]'} bg-instantly-waves opacity-100 pointer-events-none -z-10`} style={{ backgroundSize: 'cover', backgroundPosition: 'left top' }} />
