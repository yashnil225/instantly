            ...
            <div className="flex-shrink-0 bg-white relative h-full" style={{ width: '58vw' }}>
                <div className="flex flex-col items-start h-full overflow-y-auto" style={{ paddingLeft: '218px' }}>
                    ...
                    <form onSubmit={handleSubmit} style={{ width: '358px' }}>
                        ...
                        {/* Email Field → Password Field: 40px when active, Email → Tick: 50px when hidden */}
                        {showPassword ? (
                            <>
                                ...
                                {/* Password Field → Tick Area: 40px */}
                                <div style={{ height: '40px' }} />
                            </>
                        ) : (
                            /* Email Field → Tick Area when password hidden: 50px */
            ...
            <div className="hidden lg:flex w-[42vw] relative flex-col items-center justify-center p-12 h-full z-0">
                ...
                <div className="absolute top-[17px] right-[15px] z-50">
                    <a
                        ...
                        className="transition-all flex items-center justify-center p-2.5 hover:bg-slate-50/50 rounded-[6px] border border-[#dee2e6]"
                        title="Home"
                    >
