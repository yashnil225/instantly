            ...
            <div className="signup-container">
                ...
                <div className="signup-form-section">
                    ...
                    <form onSubmit={handleSubmit} className="auth-form">
                        ...
                        <button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-lg px-6 py-3 font-medium transition-all disabled:opacity-70 disabled:cursor-not-allowed" disabled={loading}>
                    ...
                    <div className="social-buttons">
                        <button type="button" className="flex items-center justify-center gap-3 w-full px-4 py-3 bg-transparent border border-border rounded-lg text-foreground hover:bg-muted transition-colors font-medium" onClick={handleGoogleSignIn}>
