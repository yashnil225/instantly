        ...
        <div className="relative flex flex-col md:flex-row bg-white h-screen overflow-hidden">
                ...
                <div className="h-full flex flex-col items-center md:items-start md:pl-[218px] py-12 lg:py-0">
                    ...
                    <div className="flex flex-col items-start px-4 md:px-0">
                        ...
                        >
                            ...
                            <span className="text-[15.5px] font-semibold text-slate-700 tracking-[0.04em] relative top-[1px]">Sign Up with Google</span>
                        </button>
                        ...
                        >
                            ...
                            <span className="text-[15.5px] font-semibold text-slate-700 tracking-[0.04em] relative top-[1px]">Sign Up with Apple</span>
                        </button>
            ...
            <div className="hidden md:flex w-[42vw] relative flex-col items-center justify-center p-12 h-full z-0">
                ...
                <div className="relative z-10 max-w-md text-center flex flex-col items-center mt-[-80px] left-[-4px]">
                    ...
                    <div className="w-[198px] h-auto mb-12 animate-in slide-in-from-bottom-4 duration-1000">
                    ...
                    <p className="text-slate-600 text-[15px] leading-[2.0] max-w-sm font-medium">
