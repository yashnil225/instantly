...
import {
  ...
  handleCreateSequenceStep,
  updateSequenceVariantSchema,
  handleUpdateSequenceVariant,
  deleteSequenceStepSchema,
  handleDeleteSequenceStep,
...
import {
  ...
  updateWarmupSchema,
  handleUpdateWarmup,
  linkAccountToCampaignSchema,
  handleLinkAccountToCampaign,
} from "./tools/accounts.js"
import {
  getUniboxThreadsSchema,
  handleGetUniboxThreads,
  updateThreadSchema,
  handleUpdateThread,
} from "./tools/unibox.js"
import {
    ...
    try {
      ...
      switch (name) {
        ...
        case "instantly_list_campaigns":
          result = await handleListCampaigns(args as any)
          break
        case "instantly_get_campaign":
          result = await handleGetCampaign(args as any)
          break
        case "instantly_create_campaign":
          result = await handleCreateCampaign(args as any)
          break
        case "instantly_update_campaign_status":
          result = await handleUpdateCampaignStatus(args as any)
          break
        case "instantly_delete_campaign":
          result = await handleDeleteCampaign(args as any)
          break

        // Sequences
        case "instantly_get_sequences":
          result = await handleGetSequences(args as any)
          break
        case "instantly_create_sequence_step":
          result = await handleCreateSequenceStep(args as any)
          break
        case "instantly_update_sequence_variant":
          result = await handleUpdateSequenceVariant(args as any)
          break
        case "instantly_delete_sequence_step":
          result = await handleDeleteSequenceStep(args as any)
          break

        // Leads
        case "instantly_list_leads":
          result = await handleListLeads(args as any)
          break
        case "instantly_add_lead":
          result = await handleAddLead(args as any)
          break
        case "instantly_bulk_add_leads":
          result = await handleBulkAddLeads(args as any)
          break
        case "instantly_update_lead":
          result = await handleUpdateLead(args as any)
          break
        case "instantly_delete_lead":
          result = await handleDeleteLead(args as any)
          break

        // Accounts & Warmup
        case "instantly_list_accounts":
          result = await handleListAccounts(args as any)
          break
        case "instantly_get_account":
          result = await handleGetAccount(args as any)
          break
        case "instantly_update_warmup":
          result = await handleUpdateWarmup(args as any)
          break
        case "instantly_link_account_to_campaign":
          result = await handleLinkAccountToCampaign(args as any)
          break

        // Unibox
        case "instantly_get_unibox_threads":
          result = await handleGetUniboxThreads(args as any)
          break
        case "instantly_update_thread":
          result = await handleUpdateThread(args as any)
          break

        // Analytics
        case "instantly_get_analytics_overview":
          result = await handleGetAnalyticsOverview(args as any)
          break
        case "instantly_get_campaign_analytics":
          result = await handleGetCampaignAnalytics(args as any)
          break

        // Templates
        case "instantly_list_templates":
          result = await handleListTemplates(args as any)
          break
        case "instantly_create_template":
          result = await handleCreateTemplate(args as any)
          break
        case "instantly_delete_template":
          result = await handleDeleteTemplate(args as any)
          break
